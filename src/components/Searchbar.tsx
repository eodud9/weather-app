...
export default function Searchbar({ search, searchMine }: SearchbarProps) {
  ...
  return (
    ...
    >
      ...
      />
      <button className="bg-[#E9ECFF] text-stone-900 px-4 py-3 rounded-xl cursor-pointer hover:bg-[#E9ECFF] text-sm relative">
        Search
      </button>
      <button
        type="button"
        className="bg-[#E9ECFF] text-stone-900 px-4 py-3 rounded-xl cursor-pointer hover:bg-[#e2e4ef] text-sm"
        onClick={searchMine}
      >
        My
      </button>
